...
### Q: Web Player / Web GL をサポートする予定はありますか？
...
A: はい、可能です。ブロックを希望される対象を [ads-support@unity3d.co.jp](mailto:ads-support@unity3d.co.jp) までお知らせください。こちらでブロックいたします。

### Q: 広告がユーザーに表示される 1 日当たりの回数を制限することはできますか（インセンティブ型動画など）？
A: はい、可能です。[ads-support@unity3d.co.jp](mailto:ads-support@unity3d.co.jp) へご連絡ください。こちらで設定いたします。
